...
int main() {
    ...
    // Set the initial position of the ultrasonic sensor motor
    ultrasonicMotor.set_position_sp(-90);
    // Set the speed of the ultrasonic sensor motor
    ultrasonicMotor.set_speed_sp(ultrasonicSpeed);
    /*
    This loop switches between active and standby states based on the touch sensor input 
    and it will keep running as long as the enter button is not pressed
    */
    do {
